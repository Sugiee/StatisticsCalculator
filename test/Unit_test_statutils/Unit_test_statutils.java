...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////        
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////          
        // test samplesPerBin class
        samplesPerBin SturgesSamplesPerBinInstance = new samplesPerBin(SturgesInstance.getNumberOfBins(), 
                                                                       statisticalInstance.getMin(), 
                                                                       statisticalInstance.getMax(), 
                                                                       exampleData, 
                                                                       statisticalInstance.getNumberOfSamples());
        ...
        samplesPerBin SquareRootChoiceSamplesPerBinInstance = new samplesPerBin(SquareRootChoiceInstance.getNumberOfBins(), 
                                                                                statisticalInstance.getMin(), 
                                                                                statisticalInstance.getMax(), 
                                                                                exampleData, 
                                                                                statisticalInstance.getNumberOfSamples());
        ...
        samplesPerBin RiceRuleSamplesPerBinInstance = new samplesPerBin(RiceRuleInstance.getNumberOfBins(), 
                                                                        statisticalInstance.getMin(), 
                                                                        statisticalInstance.getMax(), 
                                                                        exampleData, 
                                                                        statisticalInstance.getNumberOfSamples());
